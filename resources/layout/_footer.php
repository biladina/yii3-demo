...
/**
 * @var ParametersService $parameter
 */
?>

<footer class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    <div class="mx-auto w-full container p-2 sm:p-4">
        <div class="sm:flex sm:items-center sm:justify-between text-center">
            <a class="hover:underline text-center hover:underline" href="https://www.yiiframework.com/" target="_blank" rel="noopener">
                <span class="text-sm text-gray-700 sm:text-center text-gray-600 dark:text-white">
                    © <?= date('Y') ?>
                    <?= Encode::content($parameter->get('app.name')) . '™. All Rights Reserved.' ?>
                </span>
            </a>
            <div class="flex mt-4 space-x-6 justify-center sm:mt-0 p-2">
                <a
                    ...
                    title="GitHub"
                >
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 291.32 291.32">
                        <path
                            fill="currentColor"
                ...
                <a
                    ...
                    title="Facebook"
                >
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 408.788 408.788">
                        <path
                            fill="currentColor"
                ...
                <a
                    ...
                    title="Twitter"
                >
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.002 512.002">
                        <path
                            fill="currentColor"
